...
/**
 * Resend Base64 Slice for EcoPowerHub AI emblem logo PNG
 * 
 * This script reads the 1024x1024 full-color emblem PNG, encodes it to Base64,
 * and outputs a specified slice as plain text (no formatting, no code fences, no trailing newline).
 * 
 * Usage:
 *   node resend-ecopowerhub-logo-slice1.mjs [sliceNumber]
 *   
 * Examples:
 *   node resend-ecopowerhub-logo-slice1.mjs     # Outputs Slice 1 (default)
 *   node resend-ecopowerhub-logo-slice1.mjs 2   # Outputs Slice 2
 *   node resend-ecopowerhub-logo-slice1.mjs 3   # Outputs Slice 3
 *   node resend-ecopowerhub-logo-slice1.mjs 4   # Outputs Slice 4
 * 
...
if (isNaN(sliceNumber) || sliceNumber < 1 || sliceNumber > 4) {
  ...
  process.stderr.write('Usage: node resend-ecopowerhub-logo-slice1.mjs [1-4]\n');
  process.exit(1);
}

// Define paths (prefer assets/generated, fallback to public/generated)
const primaryPath = join(__dirname, '../public/assets/generated/ecopowerhub-logo-full-color.1024x1024.dim_1024x1024.png');
const fallbackPath = join(__dirname, '../public/generated/ecopowerhub-logo-full-color.1024x1024.png');
